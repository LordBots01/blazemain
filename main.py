...
class WebScraper:
    ...
    def __init__(self):
        ...
        self.token = "6874605435:AAHSm71vz1Uqiu72VT_9aKnWVC0upetYbH8" # config
...
☎️ [SUPORTE](https://t.me/suporte206)
💥
"""))
    ...
    def martingale(self, result):
        if result == "WIN":
            ...
            self.bot.send_message(chat_id=self.chat_id, text=(f"""GREEN {self.direction_color} ✳️✳️"""))
            ...
            if self.count > self.gales:
                ...
                self.bot.send_message(chat_id=self.chat_id, text=(f"""❗️❗️LOSS 💢"""))
            ...
            self.bot.send_message(chat_id=self.chat_id, text=(f"""**GREEN ⚪️ ✳️✳️"""))
